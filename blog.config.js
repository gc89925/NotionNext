...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '老高分享', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个网络爱好者，新人博主', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.laogaofenxiang.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '老高分享, 博客', // 网站关键词 英文逗号隔开
